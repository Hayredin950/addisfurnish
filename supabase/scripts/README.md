...
How HabeshaHome sends signup-confirmation and password-reset emails, and how
...
BREVO_SENDER=noreply@addisfurnish.com BREVO_SENDER_NAME=HabeshaHome \
./setup-email.sh
```
...
- **Shared Brevo account**: HabeshaHome currently uses a friend's Brevo
