...
export const Route = createFileRoute("/profile")({
  ...
  head: () => ({
    meta: [
      { title: "Your Profile & Shop — AddisHome" },
      { name: "description", content: "Update your contact details and shop information." },
      { property: "og:title", content: "Your Profile — AddisHome" },
      { property: "og:description", content: "Manage your AddisHome account and shop page." },
    ],
  }),
  component: () => (
    <RequireAuth>
