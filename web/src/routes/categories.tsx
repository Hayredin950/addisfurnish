...
export const Route = createFileRoute("/categories")({
  head: () => ({
    meta: [
      { title: "Furniture Categories — AddisHome" },
      {
        name: "description",
        content:
          "Browse used furniture by room and type: living room sofas, bedroom wardrobes, office desks, dining sets, outdoor and storage.",
      },
      { property: "og:title", content: "Furniture Categories — AddisHome" },
      {
        property: "og:description",
        content: "Every room and furniture type available on AddisHome.",
      },
    ],
  }),
