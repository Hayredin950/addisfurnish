...
export const Route = createFileRoute("/shop/$slug")({
  head: () => ({
    meta: [
      { title: "Furniture Shop — AddisHome" },
      { name: "description", content: "Browse every item this seller currently has for sale." },
      { property: "og:title", content: "Furniture Shop — AddisHome" },
      { property: "og:description", content: "A verified used-furniture shop on AddisHome." },
    ],
  }),
  component: Shop,
});
