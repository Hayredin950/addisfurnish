...
function Safety() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-14">
      <h1 className="font-display text-3xl font-semibold">Buying and selling safely</h1>
      <p className="mt-2 max-w-2xl text-muted-foreground">
        SuqBet connects people directly — money and goods change hands in person. These six rules
        prevent almost every problem we see.
      </p>
      ...
      <div className="mt-10 rounded-lg border border-dashed p-6 text-sm text-muted-foreground">
        <strong className="text-foreground">Sellers:</strong> describe damage honestly and keep your
        phone number up to date. Listings that misrepresent condition get removed and the shop can
        lose its verified badge.
      </div>
    </div>
  );
}
